raspistill_def = {
    ...
    params: [
        ...
        { name: 'latest', alias: '--latest', type: 'number', active: false, default: 0, desc: 'Link latest complete image to filename <filename>' },
        ...
        { name: 'sharpness', alias: '--sharpness', type: 'number', active: false, desc: 'Setimagesharpness(-100to100)' },
        { name: 'contrast', alias: '--contrast', type: 'number', active: false, desc: 'Setimagecontrast(-100to100)' },
        { name: 'brightness', alias: '--brightness', type: 'number', active: false, desc: 'Setimagebrightness(0to100)' },
        { name: 'saturation', alias: '--saturation', type: 'number', active: false, desc: 'Setimagesaturation(-100to100)' },
        { name: 'iso', alias: '--ISO', type: 'number', active: false, desc: 'SetcaptureISO' },
        { name: 'vstab', alias: '--vstab', type: 'number', active: false, desc: 'Turnonvideostabilisation' },
        { name: 'ev', alias: '--ev', type: 'number', active: false, desc: 'SetEVcompensation-stepsof1/6stop' },
        { name: 'exposure', alias: '--exposure', type: 'number', active: false, desc: 'Setexposuremode(seeNotes)' },
        ...
        { name: 'annotate', alias: '--annotate', type: 'number', active: false, desc: 'Enable/Setannotateflagsortext' },
